...
public class SelectCalendarCheckListRequest extends StringRequest {
    final static private String URL = "http://miraclestep01.dothome.co.kr/SelectCheckListData.php"; // 서버 URL 설정 (PHP 파일 연동.)
    private Map<String, String> map;

    public SelectCalendarCheckListRequest(String userID, String date, Response.Listener<String> listener){
