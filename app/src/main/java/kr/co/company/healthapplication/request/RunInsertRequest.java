...
public class RunInsertRequest extends StringRequest {
    final static private String URL = "http://miraclestep.ivyro.net/InsertRunning.php"; // 서버 URL 설정 (PHP 파일 연동.)
    private Map<String, String> map;

    public RunInsertRequest(String userId, String runTime, String runDistance, String runStep, String runKcal, Response.Listener<String> listener){
