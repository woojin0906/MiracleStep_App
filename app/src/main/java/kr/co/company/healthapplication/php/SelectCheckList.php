<?php
    /*
      SelectCheckList.php : 홈의 체크리스트를 처리하는 php (POST 형식으로 MySQL로부터 데이터를 받아옴.)
      con : mysql 연결을 시도하는 변수.
      "$변수" 로 변수 선언
    */

/* (1) 서버 DB에 연결.*/
    $con = mysqli_connect("localhost", "miraclestep", "tndnqja11!!", "miraclestep"); // mysql 연결, IP, 사용자명, 비밀번호, 데이터베이스
